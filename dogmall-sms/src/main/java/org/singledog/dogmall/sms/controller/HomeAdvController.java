...
public class HomeAdvController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<HomeAdvEntity>> queryHomeAdvByPage(PageRequest request) {
        return homeAdvService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<HomeAdvEntity> queryHomeAdvById(@PathVariable("id") Long id) {
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody HomeAdvEntity homeAdv) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody HomeAdvEntity homeAdv) {
