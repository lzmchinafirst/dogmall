...
public class SeckillSkuController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<SeckillSkuEntity>> querySeckillSkuByPage(PageRequest request) {
        return seckillSkuService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<SeckillSkuEntity> querySeckillSkuById(@PathVariable("id") Long id) {
        SeckillSkuEntity entity = seckillSkuService.getById(id);
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody SeckillSkuEntity seckillSku) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody SeckillSkuEntity seckillSku) {
