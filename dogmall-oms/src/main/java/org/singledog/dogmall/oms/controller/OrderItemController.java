...
public class OrderItemController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<OrderItemEntity>> queryOrderItemByPage(PageRequest request) {
        return orderItemService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<OrderItemEntity> queryOrderItemById(@PathVariable("id") Long id) {
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody OrderItemEntity orderItem) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody OrderItemEntity orderItem) {
