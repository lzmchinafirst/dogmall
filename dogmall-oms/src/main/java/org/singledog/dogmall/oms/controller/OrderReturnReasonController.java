...
public class OrderReturnReasonController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<OrderReturnReasonEntity>> queryOrderReturnReasonByPage(PageRequest request) {
        return orderReturnReasonService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<OrderReturnReasonEntity> queryOrderReturnReasonById(@PathVariable("id") Long id) {
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody OrderReturnReasonEntity orderReturnReason) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody OrderReturnReasonEntity orderReturnReason) {
