...
public class WareSkuController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<WareSkuEntity>> queryWareSkuByPage(PageRequest request) {
        return wareSkuService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<WareSkuEntity> queryWareSkuById(@PathVariable("id") Long id) {
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody WareSkuEntity wareSku) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody WareSkuEntity wareSku) {
