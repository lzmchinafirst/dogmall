...
public class UserCollectSkuController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<UserCollectSkuEntity>> queryUserCollectSkuByPage(PageRequest request) {
        return userCollectSkuService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<UserCollectSkuEntity> queryUserCollectSkuById(@PathVariable("id") Long id) {
        UserCollectSkuEntity entity = userCollectSkuService.getById(id);
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody UserCollectSkuEntity userCollectSku) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody UserCollectSkuEntity userCollectSku) {
