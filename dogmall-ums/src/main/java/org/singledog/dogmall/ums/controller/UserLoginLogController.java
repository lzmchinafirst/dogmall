...
public class UserLoginLogController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<UserLoginLogEntity>> queryUserLoginLogByPage(PageRequest request) {
        return userLoginLogService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<UserLoginLogEntity> queryUserLoginLogById(@PathVariable("id") Long id) {
        UserLoginLogEntity entity = userLoginLogService.getById(id);
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody UserLoginLogEntity userLoginLog) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody UserLoginLogEntity userLoginLog) {
