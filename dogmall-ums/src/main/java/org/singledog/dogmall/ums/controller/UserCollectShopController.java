...
public class UserCollectShopController {
    ...
    @GetMapping
    @ApiOperation("分页查询")
    public Response<List<UserCollectShopEntity>> queryUserCollectShopByPage(PageRequest request) {
        return userCollectShopService.queryPage(request);
    }
    ...
    @GetMapping("{id}")
    @ApiOperation("详情查询")
    public Response<UserCollectShopEntity> queryUserCollectShopById(@PathVariable("id") Long id) {
        UserCollectShopEntity entity = userCollectShopService.getById(id);
    ...
    @PostMapping
    @ApiOperation("保存")
    public Response save(@RequestBody UserCollectShopEntity userCollectShop) {
    ...
    @PostMapping("/update")
    @ApiOperation("修改")
    public Response update(@RequestBody UserCollectShopEntity userCollectShop) {
